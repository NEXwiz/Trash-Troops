...
#ch {
 ...
 overflow: hidden;
   ...
   <body> 
   <div class="sidebar">
  <a href="http://localhost/Waste_Website/waste-management-system/index.html"  class="fa fa-home"><strong> Home - <img src="Capture.PNG" alt="LOGO"heigth='30'width='30'class='logo1'>
 </strong></a>
  <!-- <a href="#news">News</a>
  ...
  <a href="#about">About</a> -->
   ...
   <!-- <nav class="fixed-top">
    <a class="navbar-brand" href="http://localhost/Waste_Website/waste-management-system/index.html">Home</a>
    </nav>
    <br> -->
...
function confirmDelete(){
    window.location.replace("http://localhost/Waste_Website/waste-management-system/adminlogin/delete.php?i="+delId);
}
</script>
</body>
</html>
