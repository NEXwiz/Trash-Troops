...
if(isset($_POST['update'])){
  ...
  //   $filesize = $_FILES["file"]["size"] < 5 * 1024 ;
    ...
    if($data) {
       ...
       header("Location: http://localhost/Waste_Website/waste-management-system/adminlogin/welcome.php", TRUE, 301);
       exit();
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">          
					   <select class="form-control" id="location" name="location" value="<?php echo "$lo"?>">
						   <option class="form-control" >Mayur Vihar</option>
						   <option class="form-control" >Faridabad</option>
						   <option class="form-control" >Lajpat</option>
						   <option class="form-control" >Sarojni</option>
